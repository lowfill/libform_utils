<?php 
/**
 * Grid users data view
 * 
 * Handle the request made from the flexigrid view and returns basic user's data
 * 
...
$options = array('types'=>'user','count'=>true,'limit'=>50);
...
if(!empty($entities)){
	foreach($entities as $entity){
		...
		$last_access = date("d-M-Y",$entity->last_login);
		$row['cell']=array(
			$entity->guid,
			$name,
			$last_access
